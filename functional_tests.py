...
class NewsAppTest(LiveServerTestCase):
    ...
    def test_staff_can_create_and_publish_article(self):
        ...
        self.browser.find_element_by_id('id_title').send_keys('title of article')
        self.browser.find_element_by_id('id_content').send_keys('the content of article')
        self.browser.find_element_by_id('id_image').send_keys('image of article')
        self.browser.find_element_by_id('id_locale').send_keys('chose language:russian vs english')
